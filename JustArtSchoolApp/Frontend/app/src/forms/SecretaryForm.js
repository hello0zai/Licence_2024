                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 d-flex justify-content-end">
                                <Stack direction="row" spacing={1}>
                                    ...
                                    <Button variant="outlined" startIcon={config.buttonsConfig.backButton.buttonIcon} onClick={goToList}>
                        ...
                        <div className="row form-group">
                            <div className="col-md-3">
                                ...
                                {errors.countyId && touched.countyId ? (
                                    <div className={"invalid-message"}>{errors.countyId}</div>
                                ) : null}
                            </div>
                            ...
                            <div className="col-md-3">
                                ...
                                {errors.cityId && touched.cityId ? (
                                    <div className={"invalid-message"}>{errors.cityId}</div>
                                ) : null}
                            </div>
                            ...
                            <div className="col-md-6">
                                ...
                                {errors.fullAddress && touched.fullAddress ? (
                                    <div className={"invalid-message"}>{errors.fullAddress}</div>
                                ) : null}
                            </div>
                        </div>
                        ...
                        <div className="row form-group">
                            <div className="col-md-6">
                                ...
                                {errors.userAccount?.userName && touched.userAccount?.userName ? (
                                    <div className={"invalid-message"}>{errors.userAccount?.userName}</div>
                                ) : null}
                            </div>
                            ...
                            <div className="col-md-6">
                                ...
                                {errors.personalEmail && touched.personalEmail ? (
                                    <div className={"invalid-message"}>{errors.personalEmail}</div>
                                ) : null}
                            </div>
                        </div>
                        ...
                        <div className="row form-group">
                            <div className="col-md-6">
                                ...
                                {errors.cnp && touched.cnp ? (
                                    <div className={"invalid-message"}>{errors.cnp}</div>
                                ) : null}
                            </div>
                            ...
                            <div className="col-md-6">
                                ...
                                {errors.phoneNumber && touched.phoneNumber ? (
                                    <div className={"invalid-message"}>{errors.phoneNumber}</div>
                                ) : null}
                            </div>
                        </div>
