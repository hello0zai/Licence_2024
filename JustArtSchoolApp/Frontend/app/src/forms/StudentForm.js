...
function StudentForm(config) {
    const model = config.model;
    const validationSchema = config.validationSchema;
    const handleSubmit = config.handleSubmit;
    const readOnly = config.readOnly;
    const formRef = config.formRef;
    const getStudentByEmail = config.getStudentByEmail;
                ...
                <Form>
                    <div className="row form-group">
                        <div className="col-md-6">
                            ...
                            <Field
                                ...
                                readOnly={readOnly}
                            />
                            {/*<ErrorMessage name="lastName" component="div" className="invalid-message" />*/}
                    ...
                    <div className="row form-group">
                        <div className="col-md-6">
                            ...
                            <Field
                                type="text"
                                className={errors.userAccount && touched.userAccount ? "form-control is-invalid" : "form-control"}
                                id="userAccount.userName"
                                placeholder="Nume utilizator"
                                value={values.userAccount?.userName}
                                readOnly={readOnly}
                            />
                            {errors.userAccount && touched.userAccount ? (
                        ...
                        <div className="col-md-6">
                            ...
                            <Field
                                ...
                                readOnly={readOnly}
                                onBlur = {(event) => getStudentByEmail(event)}
                            />
                    ...
                    <div className="row form-group">
                        <div className="col-md-6">
                            ...
                            <Field
                                type="text"
                                className={errors.occupation && touched.occupation ? "form-control is-invalid" : "form-control"}
                                id="occupation"
                                name="occupation"
                            ...
                            {errors.occupation && touched.occupation ? (
                                <div className={"invalid-message"}>{errors.occupation}</div>) : null}
                        </div>
                        ...
                        <div className="col-md-6">
                            ...
                            <Field
                                className={errors.studies && touched.studies ? "form-control is-invalid" : "form-control"}
                                id="studies"
                                name="studies"
                                placeholder="Studii"
                            ...
                            {errors.studies && touched.studies ? (
                                <div className={"invalid-message"}>{errors.studies}</div>) : null}
                        </div>
                    </div>
                </Form>)}
        </Formik>
